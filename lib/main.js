...
function check_director() {
    ...
    execute("search/person", { "query": director_name_input })
        ...
        let table_html = "<tr><th class=\"table-vertical-header\"></th>" + movie_set.descriptions.map((description) => "<th>" + description.name + " (" + description.release_date.getFullYear() + ")" + "</th>").join("") + "<th>Total</th></tr>";
        let top_n_to_show = document.getElementById('top_n_edit').valueAsNumber;
